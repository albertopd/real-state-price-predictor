...
class PropertyPreprocessor:
    def __init__(self):
        ...
        self.data_path = os.path.join(
            base_dir, "data", "georef-belgium-postal-codes.csv"
        )
    ...
    def preprocess(self, data: PropertyInput) -> dict:
        ...
        preprocessed_data["type_encoded"] = self.get_type_encoded(
            preprocessed_data["type"]
        )
        preprocessed_data["subtype_encoded"] = self.get_subtype_encoded(
            preprocessed_data["subtype"]
        )
        preprocessed_data["epcScore_encoded"] = self.get_EPC_encoded(
